...
```{r}
readLines("/use/share/class/bonus/arthur_doyle.txt", 30) 
```
...
```{r}
twain_path <- paste0("file:///use/share/class/bonus/mark_twain.txt")
twain <-  spark_read_text(sc, "twain", twain_path) 
```

2. Read the *arthur_doyle.txt* file into Spark
```{r}
doyle_path <-  paste0("file:///use/share/class/bonus/arthur_doyle.txt")
